                        ...
                        <form action="" method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model.defer="name" class="form-control" placeholder="Enter Full Name" />
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model.defer="shipping_zip_code" class="form-control" placeholder="Enter Zip-code" />

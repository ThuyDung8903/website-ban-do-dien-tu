                        ...
                        <div class="card-header row align-items-center justify-content-between pt-3">
                            ...
                            <div class="col-12 col-xl-auto">
                                <a class="btn btn-sm btn-outline-blue-soft text-primary"
                                        href="{{ route('admin.order-status.list') }}">
                                    <i class="me-1" data-feather="arrow-left"></i>
                                    Back to Order-statuses List
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <form enctype="multipart/form-data"
                                            action="{{ route('admin.order-status.do-edit', ['id' => $obj->id]) }}"
                                            method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="name">Name</label>
                                            <input class="form-control" id="name" name="name" type="text"
                                                    placeholder="Input name order-status" value="{{ $obj->name }}"/>
                                        </div>

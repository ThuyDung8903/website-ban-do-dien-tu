                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <a href="javascript: void(0);" class="text-center d-block mb-4">
                                    <img src="https://cdn.sforum.vn/sforum/wp-content/uploads/2018/11/3-8.png" class="img-fluid"
                                            style="max-width: 280px;" alt="Product-img">
                                </a>

                                <div class="d-lg-flex d-none justify-content-center slideshow">
                                    ...
                                    <a href="javascript: void(0);" class="ms-2">
                                        <img src="https://haycafe.vn/wp-content/uploads/2021/12/Hinh-anh-tam-su-buon-nguoi-go.jpg"
                                                class="img-fluid img-thumbnail p-2" style="max-width: 75px;"
                                                alt="Product-img">
                                    </a>
                                    <a href="javascript: void(0);" class="ms-2">
                                        <img src="https://haycafe.vn/wp-content/uploads/2022/01/Hinh-anh-cute.jpg"
                                                class="img-fluid img-thumbnail p-2" style="max-width: 75px;"
                                                alt="Product-img">
                                    </a>
                                </div>
                            ...
                            <div class="col-lg-7">
                                <form class="ps-lg-4">
                                    <!-- Product title -->
                                    <h3 class="mt-0">Amazing Modern Chair (Orange) <a href="javascript: void(0);"

        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.do-add') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="tab-pane fade border p-3 show active" id="home" role="tabpanel"
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" id="inputNameProduct" name="name" type="text"
                                                    placeholder="Enter your product's name" value="{{ old('name') }}"/>
                                        </div>
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input class="form-control" id="slug" name="slug" type="text"
                                                placeholder="Enter slug">{{ old('slug') }}</input>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputDetailDescription">Detail Description</label>
                                        <textarea class="form-control" id="inputDetailDescription" name="detail_description"
                                                type="text" rows="10"
                                                placeholder="Enter detail_description">{{ old('detail_description') }}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" id="inputMetaTitle" name="meta_title"
                                                    type="text"
                                                    placeholder="Enter meta_title" value="{{ old('meta_title') }}"/>
                                        </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" id="inputSalePrice" name="sale_price"
                                                    type="text"
                                                    placeholder="Enter sale_price" value="{{ old('sale_price') }}"/>
                                        </div>
                                        <!-- Form Group (quantity)-->
                                        <div class="col-md-4">

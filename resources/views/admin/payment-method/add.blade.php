                ...
                <div id="default">
                    <div class="card mb-4">
                        <div class="card-header row align-items-center justify-content-between pt-3">
                            <div class="col-auto">Add a new payment-method</div>
                            <div class="col-12 col-xl-auto">
                                <a class="btn btn-sm btn-outline-blue-soft text-primary"
                                        href="{{ route('admin.payment-method.list') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <form enctype="multipart/form-data" action="{{ route('admin.payment-method.do-add') }}"
                                            method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="name">Name</label>
                                            <input class="form-control" id="name" name="name" type="text"
                                                    placeholder="Input name payment-method" value="{{ old('name') }}"/>
                                        </div>
                                        <div class="mb-3">

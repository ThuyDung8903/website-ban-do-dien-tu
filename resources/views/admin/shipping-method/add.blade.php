    ...
    <div class="container-xl px-4 mt-n10">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="default">
                    <div class="card mb-4">
                        <div class="card-header">Add a new shipping-method</div>
                        <div class="card-body">
                            @if($errors->any())
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <form enctype="multipart/form-data" action="{{ route('admin.shipping-method.do-add') }}"
                                            method="post">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="name">Name</label>
                                            <input class="form-control" id="name" name="name" type="text"
                                                    placeholder="Input name shipping-method" value="{{ old('name') }}"/>
                                        </div>
                                        <div class="mb-3">
                                            <label for="shipping_fee">Shipping-fee</label>
                                            <input class="form-control" id="shipping_fee" name="shipping_fee" type="text"
                                                    placeholder="Input shipping_fee" value="{{ old('shipping_fee') }}"/>
                                        </div>
                                        <div class="mb-3">
